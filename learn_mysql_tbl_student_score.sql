...
LOCK TABLES `tbl_student_score` WRITE;
/*!40000 ALTER TABLE `tbl_student_score` DISABLE KEYS */;
INSERT INTO `tbl_student_score` VALUES (1,'Jane','english',100),(2,'micheal','english',98),(3,'kangkang','english',76),(4,'flight','english',93),(5,'flight','math',100),(6,'kangkang','math',92),(7,'micheal','math',65),(8,'Jane','math',70);
...
-- Dump completed on 2019-05-11  8:21:49
